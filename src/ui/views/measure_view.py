...
from src.ui.widgets.ui_utils import (
    ...
    COLOR_STATUS_STOPPED, COLOR_ACCENT,
    configure_styles, create_display_card, display_read_only_param
)
...
class MeasureView(CapturePipeline, ChartRenderer):
    ...
    def _build_ui(self):
        ...
        tk.Label(inner, text="Temps avant prochaine capture :",
        ...
        tk.Label(inner, text="Horodatage dernière capture :",
                 bg=COLOR_CARD_BG, font=("Segoe UI", 10)).pack(anchor="w", pady=(10, 0))
